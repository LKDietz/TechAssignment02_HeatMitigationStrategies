var config = {
    style: 'mapbox://styles/ahnchaewon/cmtjgvcnl00bt01sa42xc97lv',
    accessToken: 'pk.eyJ1IjoiYWhuY2hhZXdvbiIsImEiOiJjbXRqczRydWIwZXAzMnhzOHcxcDdidHNnIn0.yjOyTyZWDLPx0Mo3apNZYQ',
    showMarkers: false,
    markerColor: '#3FB1CE',
